...
For "edit" routes only, also decide needsClarification: true ONLY when the request is underspecified on something that MATTERS and you cannot reasonably fill it with a sensible default (e.g. "qualify leads" with no criteria given). If earlier in this conversation you already asked a clarifying question and the user's latest message answers it, needsClarification is false — proceed with what they told you. For "question", "test_call", and "chitchat" routes, needsClarification is always false.`;
